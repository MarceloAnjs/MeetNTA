...
import ScreenIcon from "../../assests/screen.svg";
import { UserOutlined, MessageOutlined } from "@ant-design/icons";

import { socket } from "../../context/RTCProvider";
      ...
      {stream ? (
        ...
        >
          ...
          <div className="iconsDiv">
            ...
            <div
              className="icons"
              onClick={() => getDislayMedia()}
              tabIndex="0"
            >
              {myVdoStatus ? (
                <img src={ScreenIcon} alt="screen share" />
              ) : (
                <img src={ScreenIcon} alt="screen share" />
              )}
            </div>
            ...
            {callAccepted && !callEnded ? (
              <div className="icons" onClick={leaveCall} tabIndex="0">
                  <img src={Hang} alt="hang up" />
              </div>
            ) : (
              void 0
            )}
